...
public class CaughtMovie implements Comparable<CaughtMovie>{
	...
	@Override
	public int compareTo(CaughtMovie compareMovie) {
		int compareRating = ((CaughtMovie) compareMovie).getRating();
